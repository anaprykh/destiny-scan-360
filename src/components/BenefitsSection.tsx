...
const benefits = [
  ...
  },
  {
    ...
    description: "По линиям руки раскрывается, что заложено вам по судьбе, какие у вас сильные и слабые стороны, через какие жизненные повороты вы проходите и что несёте в себе ваш род"
  },
  {
    icon: Users,
